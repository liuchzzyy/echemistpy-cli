...
def discretemap(colormap, hexclrs):
    ...
    for ki, key in enumerate(("red", "green", "blue")):
        cdict[key] = [(i / (len(clrs) - 2.0), clrs[i, ki], clrs[i + 1, ki]) for i in range(len(clrs) - 1)]
...
class TOLcmaps(object):
    ...
    def __sunset_discrete(self):
        ...
        """
        clrs = ["#364B9A", "#4A7BB7", "#6EA6CD", "#98CAE1", "#C2E4EF", "#EAECCC", "#FEDA8B", "#FDB366", "#F67E4B", "#DD3D2D", "#A50026"]
    ...
    def __nightfall_discrete(self):
        ...
        """
        clrs = ["#125A56", "#238F9D", "#60BCE9", "#C6DBED", "#ECEADA", "#F9D576", "#FD9A44", "#E94C1F", "#A01813"]
        self.cmap = discretemap(self.cname, clrs)
        self.cmap.set_bad("#FFFFFF")
    ...
    def __BuRd_discrete(self):
        ...
        """
        clrs = ["#2166AC", "#4393C3", "#92C5DE", "#D1E5F0", "#F7F7F7", "#FDDBC7", "#F4A582", "#D6604D", "#B2182B"]
        self.cmap = discretemap(self.cname, clrs)
    ...
    def __PRGn_discrete(self):
        ...
        """
        clrs = ["#762A83", "#9970AB", "#C2A5CF", "#E7D4E8", "#F7F7F7", "#D9F0D3", "#ACD39E", "#5AAE61", "#1B7837"]
        self.cmap = discretemap(self.cname, clrs)
        self.cmap.set_bad("#FFEE99")
    ...
    def __YlOrBr_discrete(self):
        ...
        """
        clrs = ["#FFFFE5", "#FFF7BC", "#FEE391", "#FEC44F", "#FB9A29", "#EC7014", "#CC4C02", "#993404", "#662506"]
        self.cmap = discretemap(self.cname, clrs)
    ...
    def __WhOrBr(self):
        ...
        """
        clrs = ["#FFFFFF", "#FFF7BC", "#FEE391", "#FEC44F", "#FB9A29", "#EC7014", "#CC4C02", "#993404", "#662506"]
        self.cmap = LinearSegmentedColormap.from_list(self.cname, clrs)
        self.cmap.set_bad("#888888")
...
def tol_cmap(colormap=None, lut=None):
    ...
    if colormap not in obj.namelist:
        ...
        print("*** Warning: requested colormap not defined,", "known colormaps are {}.".format(obj.namelist), "Using {}.".format(colormap))
...
def tol_cset(colorset=None):
    ...
    if colorset not in namelist:
        colorset = "bright"
        print("*** Warning: requested colorset not defined,", "known colorsets are {}.".format(namelist), "Using {}.".format(colorset))

    if colorset == "bright":
        cset = namedtuple("Bcset", "blue red green yellow cyan purple grey black")
        return cset("#4477AA", "#EE6677", "#228833", "#CCBB44", "#66CCEE", "#AA3377", "#BBBBBB", "#000000")
    ...
    if colorset == "vibrant":
        ...
        return cset("#EE7733", "#0077BB", "#33BBEE", "#EE3377", "#CC3311", "#009988", "#BBBBBB", "#000000")

    if colorset == "muted":
        cset = namedtuple("Mcset", "rose indigo sand green cyan wine teal olive purple pale_grey black")
        return cset("#CC6677", "#332288", "#DDCC77", "#117733", "#88CCEE", "#882255", "#44AA99", "#999933", "#AA4499", "#DDDDDD", "#000000")
    ...
    if colorset == "light":
        ...
        return cset("#77AADD", "#EE8866", "#EEDD88", "#FFAABB", "#99DDFF", "#44BB99", "#BBCC33", "#AAAA00", "#DDDDDD", "#000000")
...
def main():
    ...
    for ax, scheme in zip(axes, schemes, strict=False):
        ...
        fig.text(pos[0] - 0.01, pos[1] + pos[3] / 2.0, scheme, va="center", ha="right", fontsize=10)
    plt.show()
    ...
    for lut, ax in enumerate(axes, start=1):
        ...
        fig.text(pos[0] - 0.01, pos[1] + pos[3] / 2.0, "rainbow_discrete, " + str(lut), va="center", ha="right", fontsize=10)
    plt.show()
